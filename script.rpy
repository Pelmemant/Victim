...
label start:
    play music "bg_music.mp3" fadeout 1.0
    scene black
...
label First:
    ...
    g "Кто ты?" 
    g "Отпусти меня!"
    r 'Ну же, ну же, маленький.'
    'Во тьме блеснули его зубы, когда он улыбнулся.'
    r 'Ты здесь, со мной, это самое главное.'
    r 'Кто я? Я друг…'
    show drug curiosity
...
label third_right:
    show drug happy
    "Когда я сказал ответ, друг вскочил и подбежал ко мне"
    d "Верно верно, ты опять отгадал верно!"
    d "Что же ты такой умный? Умный, разумный?"
    "Он схватил меня за щуки и начал тянуть их."
    d "Молодец, молодец, молодец, молодец."
    "От его прикосновений было больно, и я попытался выбраться."
    "Но так как я был крепко привязан к стулу, все мои попытки были тщетны."
    show drug wait
    d "Ну ну ну ну."
    "Он начал гладить меня по голове"
    d "Не убегай. Мы ещё повеселимся."
    d "Давай, давай, вот тебе ещё загадка"
    $ riddle_turn += 1
    jump riddle_router
...
label third_right_2:
    ...
    "Он схватил меня за щуки и начал тянуть их."
    d "Молодец, молодец, молодец, молодец."
    "От его прикосновений было больно, но эта боль и рядом не стояла с болью от руки."
    "Хотелось плакать, но я держался."
    show drug wait
    d "Ну ну ну ну."
    "Он начал гладить меня по голове"
    d "Не дергайся. Мы ещё повеселимся."
    d "Давай, давай, вот тебе ещё загадка"
    $ riddle_turn += 1
    jump riddle_router
...
label fourth_right:
    show drug happy
    d "Ты справился, справился, справился!"
    "Друг буквально выпрыгивал из трусов после того как я сказал ответ"
    "Комната наполнилась металическим звоном пока он плясал."
    d "Ты справился ты со всем справился!"
    d "Ну как же ты мог не справиться!"
    d "Тебя выбрал я! Я! Понимаешь?!"
    d "Конечно же я не могу ошибаться! Никогда не ошибался и сейчас не ошибся!"
    d "И сейчас не ошибся"
    d "Он остановился запыхавшись"
    d "Последняя. Осталась последняя!"
    $ riddle_turn += 1
    jump riddle_router
...
label end_riddle:
    ...
    show drug wait
    "Услышав мой ответ Друг остановился"
    "Казалось он завис, улыбка сошла с его лица, он явно о чём-то задумался"
    show drug curiosity
    "Хорошо."
    "Наконец сказал он"
    "В ту же секунду путы что сдерживали меня пали"
    "Я наконец мог двигать ногами и руками"
    "Ты свободен."
    "Сказал друг и указал за спину."
    "Там выход. Иди."
    "Он вновь улыбнулся."
    "Теперь его улыбка была куда как шире."
    "Клянусь она шла от уха до уха."
    "Так улыбаться человек не мог."
    "На одеревеневших ногах я кинулся к выходу"
...
label good_ending_1:
    ...
    "необращая ни на что внимание."
    "И с каждым моим шагов свет становился ближе."
    "Пока..."
    "..."
    "..."
    "..."
    "Я не оказался на улице."
    "Жертва. Конец."
    return
...
label good_ending_2:
    ...
    "Я бежал бежал и бежал."
    "Необращая ни на что внимание."
    "Прижав к себе покалеченную руки."
    "И с каждым моим шагов свет становился ближе."
    "Пока..."
    "..."
    "..."
...
label bad_ending_1:
    ...
    ""
    show drug wait
    "Ты свободен, но не можешь уйти!"
    "Ты не угадал, а значит..."
    "Давай поиграем ещё!"
    "Жертва. Конец."
    return
